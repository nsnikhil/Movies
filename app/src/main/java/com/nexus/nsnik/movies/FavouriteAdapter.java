...
public class FavouriteAdapter extends android.support.v4.widget.CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        String title = cursor.getString(cursor.getColumnIndex(table1.mTitle));
    ...
    private Bitmap getBitmap(Context c, Cursor cursor) {
        ...
        File fi = new File(folder, cursor.getString(cursor.getColumnIndex(table1.mPosterPath)));
